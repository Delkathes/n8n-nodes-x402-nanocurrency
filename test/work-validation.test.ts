...
describe('parseWorkValidation', () => {
	it('accepts base-difficulty valid_all responses', () => {
	...
	it('rejects receive-tier-only work (valid_receive without valid_all)', () => {
		expect(parseWorkValidation({ valid_all: '0', valid_receive: '1' })).toBe(false);
